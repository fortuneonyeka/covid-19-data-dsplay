// import aCountries from "./africa";
import { addCountry, setTotal } from '../redux/covid-19/covid-19';
const baseURL = 'https://api.covid19tracking.narrativa.com/api';


 export const MAPS_API = 'https://github.com/djaiss/mapsicon/tree/master/all';

 const mapSource = (iso) => {
   const options = '64.png';
   return `${MAPS_API}/${iso}/${options}`;
 };
